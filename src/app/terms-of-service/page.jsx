export default function TermsOfService() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-12 text-gray-900 bg-gray-50 min-h-screen">
      <h1 className="text-7xl font-bold mb-12 text-center">Terms of service</h1>

      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">OVERVIEW</h2>
        <p className="mb-4">
          This website is operated by Excited &amp; Sexhausted. Throughout the
          site, the terms “we”, “us” and “our” refer to Excited &amp;
          Sexhausted. Excited &amp; Sexhausted offers this website, including
      ...
      {/* Repeat similar pattern for each section */}
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          non-infringement. In no case shall Excited & Sexhausted, our
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          You agree to indemnify, defend and hold harmless Excited & Sexhausted
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-3">SECTION 16 - TERMINATION</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        ...
        <p>
          ...
          <a
            href="mailto:info@excitedsexhausted.com"
            className="underline text-blue-600"
          >
            info@excitedsexhausted.com
          </a>
          .
        </p>
        <p>
          Our contact information is posted below: info@excitedsexhausted.com.
        </p>
      </section>
    </main>
  );
